    ...
    export default {
        ...
        methods: {
            expand:function(event){
                ...
                this.baseX = this.eventTarget.x + this.eventTarget.width/2 - circle.width/2
                this.baseY = this.eventTarget.y + this.eventTarget.height/2 - circle.height/2
                this.$refs.baseCircle.style.left = this.baseX + 'px'
                this.$refs.baseCircle.style.top = this.baseY + 'px'
